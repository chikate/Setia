<template>
  <div class="flex-column">
    ...
    <div class="flex-row gap-2 p-2 border-1 h-full overflow-auto">
      <div class="flex-column">
        <span style="min-width: 20px" class="text-right" v-for="n in lineCount" :key="n">
          {{ n }}
        </span>
      </div>
      <div
...
// Autocomplete Data
const suggestions = ['apple', 'banana', 'carrot', 'date', 'eggplant', 'fig', 'grape']
