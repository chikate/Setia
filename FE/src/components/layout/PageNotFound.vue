<template>
  <div class="bg-cover bg-center h-full w-full text-center" :style="`background-image: url()`">
    <div class="flex-column align-items-center justify-content-center h-full w-full">
