...
export function MessageModelToJSONTyped(value?: MessageModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sentDate': value['sentDate'] === null ? null : ((value['sentDate'] as any)?.toISOString()),
