...
export function QuestionModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    correctAnswers:
      json["correctAnswers"] == null ? undefined : json["correctAnswers"],
...
export function QuestionModelToJSONTyped(
  value?: QuestionModel | null,
