...
export function UserModelToJSONTyped(value?: UserModel | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'birthDay': value['birthDay'] == null ? value['birthDay'] : value['birthDay'].toISOString(),
        'friends': value['friends'],
        'saves': value['saves'],
        'name': value['name'],
        'emailVerifiedDate': value['emailVerifiedDate'] == null ? value['emailVerifiedDate'] : value['emailVerifiedDate'].toISOString(),
        'avatar': value['avatar'],
        'id': value['id'],
