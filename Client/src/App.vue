<template>
  <div id="sidebar" class="bg-primary sidebar">
    <div
    ...
    >
      <div class="flex-row py-2 hover:bg-gray-300">
        <div
          class="flex-row align-items-center w-full"
          @click="onNodeClick(item.key)"
        >
    ...
    <!-- <div v-else class="w-full p-2">
        <Button
          icon="pi pi-user"
          size="small"
          @click="onNodeClick(`/@/${authService?.user?.name}`)"
        />
        <Button
          icon="pi pi-cog"
          size="small"
...
/* Router view padding for mobile */
body {
  padding-bottom: 64px;
}
...
@media (min-width: 720px) {
  ...
  .router-view.sidebar-expanded {
    padding-left: 240px;
  }
}
</style>

/* Expanded state */ .sidebar.expanded { width: 240px; }
#router-view.sidebar-expanded { padding-left: 240px; } .border-round-right {
border-top-right-radius: 0.5rem; border-bottom-right-radius: 0.5rem; } /*
#sidebar:hover { min-width: 300px; width: 300px; max-width: 100vw; } */
