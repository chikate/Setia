<template>
  <div class="flex flex-row h-full">
    <div class="flex flex-column align-items-center gap-4 mm-w-100rem">
      <div
        v-for="(room, room_index) in rooms"
        :key="room_index"
        class="flex flex-column custom-shadow-1 w-full"
        :class="{ 'border-gray-400': tabIndex[0] == room_index }"
        @click="tabIndex[0] = room_index"
      >
        <div
          class="flex flex-column gap-2 p-2 align-items-start border-round"
          :style="{
